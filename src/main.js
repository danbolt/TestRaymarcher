...
Gameplay.prototype.create = function () {
	...
	sphereRadius: { type: '1f', value: 24 },
	boxTransform: { type: 'mat4', value: mat4.create() },
	boxRadius: { type: '1f', value: 32 },
    ...
    mat4.translate(this.filter.uniforms.boxTransform.value, this.filter.uniforms.boxTransform.value, vec3.fromValues(0.5, 0.5, 0));
...
Gameplay.prototype.update = function () {
    ...
    mat4.rotate(this.filter.uniforms.boxTransform.value, this.filter.uniforms.boxTransform.value, 0.01, vec3.fromValues(-1, -10, -5));
    this.filter.update();
};
